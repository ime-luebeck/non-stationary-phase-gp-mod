% EIT_DEMO_SMALL_SCALE
% 
% Description
%   Perfusion/ventilation separation on a small subset of the data
%   containing only 10x10 pixel.
...
U_dim0 = apxGrid('create',x0,true,[10]);
U_dim1 = apxGrid('create',x1,true,[10]);
...
% Optimization
% Order of Hyperparameters:
% [ell_spat1, ell_SE_time, ell_PE_time, p_time, sf_time, ell_spat1, ell_SE_time, ell_PE_time, p_time, sf_time]
...
elapsed_time = toc;
disp(['Time for Hyp-Learning: ', num2str(elapsed_time)]);
